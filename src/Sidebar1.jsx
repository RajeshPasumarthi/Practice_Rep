...
// Placeholder pages
const InboxPage = () => <div>Inbox Page Content</div>;
const StarredPage = () => <div>Starred Page Content</div>;
const SendMailPage = () => <div>Send Mail Page Content</div>;
const DraftsPage = () => <div>Drafts Page Content</div>;
    ...
    <Router>
      <Box sx={{ display: 'flex', height: '100%' }}>
        ...
        >
          ...
          <List>
            {[
              { text: 'Inbox', page: <InboxPage /> },
              { text: 'Starred', page: <StarredPage /> },
              { text: 'Send email', page: <SendMailPage /> },
              { text: 'Drafts', page: <DraftsPage /> },
            ].map((item, index) => (
        ...
        <Main open={open} sx={{ height: '100vh' }}>
          ...
          <div className="main-content">
            <Routes>
              ...
              <Route path="/send-email" element={<SendMailPage />} />
